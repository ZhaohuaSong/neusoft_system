...
class CreateClientHistoryDatas(PublicWays):
    ...
    def time_interval(self):
        ...
        pre_time = timestamp - 48*ONEDAY
        last_time = timestamp - 47*ONEDAY
    ...
    def onemin_data(self, qs):
        ...
        print len(self.incoming_interface_list), 'kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk'
...
######################################################################################################################
            ...
            # for i in range(len(in_group_list)):
            #     print in_group_list[i]
            for i in range(len(in_group_list[0])):
                ...
                in_inter = GHistoryUint1Min(itemid=in_clientid, clock=ti, value=in_value, ns=int(in_args.keys()[0]))
                out_inter = GHistoryUint1Min(itemid=out_clientid, clock=ti, value=out_value, ns=int(out_args.keys()[0]))
                # print in_value
                # print out_value
    ...
    def group_history_5min_data(self):
        ...
        for i in range(len(in_itemid)):
            ...
            for j in range(len(in_list)/5):
                ...
                in_val = GHistoryUint5Min(itemid=in_itemid[i], clock=ti, value_min=in_min_val, value_max=in_max_val, value_avg=in_avg_val, value=in_list[j*5+4])
                out_val = GHistoryUint5Min(itemid=out_itemid[i], clock=ti, value_min=out_min_val, value_max=out_max_val, value_avg=out_avg_val, value=out_list[j*5+4])
