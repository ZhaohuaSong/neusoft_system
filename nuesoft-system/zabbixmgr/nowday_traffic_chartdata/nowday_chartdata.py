#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2018/8/28 10:39
# @Author  :
# @Site    :
# @File    : nowday_chartdata.py
# @Software: PyCharm
...
class NowdayChartData():
    ...
    def set_args(self, id_list):
        ...
        self.pre_time = int(id_list[2])
        self.last_time = int(id_list[3])

    def get_itemid(self):
        port = SheetsInterface.objects.get(id=self.id)
