...
//  Datatables 初始化页面 关键绑定 ID (dynamic-table)
    var pospDataTable = $('#dynamic-table').DataTable({
            ...
            "ajax": {
                ...
                "data": function (d) {
                    return $.extend({}, d, {
                        "id": window.location.pathname //设置查询参数
                    });
            }
            },
            ...
            "fnRowCallback": function (nRow, aData, iDataIndex) {
                $('td:eq(-1)', nRow).html('<div class="hidden-sm hidden-xs action-buttons"> '
                    + '<a class="green" href="/zabbixmgr/chart/show/' + aData[0] + '/0' + '">'
                    ...
                    + '<li><a href="/zabbixmgr/chart/show/' + aData[0] + '/0' + '" class="tooltip-success" data-rel="tooltip" title="" data-original-title="Edit">'
                    + '<span class="green">'
    ...
    $("#btn-update").bind("click",
        function () {
            ...
            if (ids == 0) {
                ...
                window.location.href = "edit/" + ids[0] + '/0'
            }
        });
...
// 通用的新增方法
    ...
    $("#btn-search").click(function () {
            var args1 = window.location.pathname;
            console.info(args1);
