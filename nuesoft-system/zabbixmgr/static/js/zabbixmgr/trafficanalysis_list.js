                ...
                "data": function (d) {
                    return $.extend({}, d, {
                      "id": $('#sech_item').attr('role'),
                        "table_id":$('#sech_item_tableid').attr('tableid')
                    });
                }
            },
...
// 通用的新增方法
    ...
    $("#btn-search").click(function () {
            ...
            var args2 = $("#in-search_1").val();
            var args3 = $("#in-search_2").val();
            var args4 = chart_id;
            //var args2 = $("#input2").val();
            //用空格隔开，达到多条件搜索的效果，相当于两个关键字
            pospDataTable.search(args1).draw();
            pospDataTable.search(args2).draw();
            pospDataTable.search(args3).draw();
            pospDataTable.search(args4).draw();
   ...
   //监听输入的回车事件
    ...
    function onClick(event, treeId, treeNode, clickFlag) {
        ...
        $('#sech_item_tableid').attr('tableid', treeNode.table_id);
        //alert(treeNode.id)
