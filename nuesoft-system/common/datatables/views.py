...
class DatatableMixin(object):
    ...
    columns = []
    order_columns = []
    max_display_length = 1000  # max limit of records returned, do not allow to kill our server by huge sets of data
    ...
    @property
    def _querydict(self):
        # 调用属性 _querydict 获取自定义的ajax的参数
        # print self._querydict.get("extra_search", "YYYY")
    ...
    def filter_queryset(self, qs):
        ...
        if not self.pre_camel_case_notation:
            ...
            #q = Q()
            q = self.format_base_search_Q(search)
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        try:
            ...
            if self.pre_camel_case_notation:
                ...
                print total_display_records, total_records
