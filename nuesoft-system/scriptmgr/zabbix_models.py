...
class GraphDiscovery(models.Model):
    graphdiscoveryid = models.BigIntegerField(primary_key=True)
    ...
    class Meta:
        ...
        unique_together = (('graphid', 'parent_graphid'),)
...
class HistoryStrSync(models.Model):
...
class HistoryUintSync(models.Model):
    id = models.BigAutoField(primary_key=True)
    nodeid = models.IntegerField()
    itemid = models.BigIntegerField()
    clock = models.IntegerField()
...
class Ids(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'ids'
        unique_together = (('nodeid', 'table_name', 'field_name'),)
...
class NodeCksum(models.Model):
    nodeid = models.ForeignKey('Nodes', models.DO_NOTHING, db_column='nodeid')
    tablename = models.CharField(max_length=64)
    recordid = models.BigIntegerField()
    cksumtype = models.IntegerField()
    cksum = models.TextField()
    sync = models.CharField(max_length=128)
...
class Nodes(models.Model):
    ...
    masterid = models.ForeignKey('self', models.DO_NOTHING, db_column='masterid', blank=True, null=True)
...
class SysmapsElements(models.Model):
    ...
    elementtype = models.IntegerField()
    iconid_off = models.ForeignKey(Images, models.DO_NOTHING, db_column='iconid_off', blank=True, null=True)
    ...
    iconid_maintenance = models.ForeignKey(Images, models.DO_NOTHING, db_column='iconid_maintenance', blank=True, null=True)
...
class TriggerDiscovery(models.Model):
    triggerdiscoveryid = models.BigIntegerField(primary_key=True)
    triggerid = models.ForeignKey('Triggers', models.DO_NOTHING, db_column='triggerid')
    ...
    class Meta:
        ...
        unique_together = (('triggerid', 'parent_triggerid'),)
...
class UserHistory(models.Model):
    ...
    userid = models.ForeignKey('Users', models.DO_NOTHING, db_column='userid', unique=True)
