...
//  Datatables 初始化页面 关键绑定 ID (dynamic-table)
    var pospDataTable = $('#dynamic-table').DataTable({
            ...
            //        + '<a class="green" href="/cabinetmgr/networkdevice/list/' + aData[0] + '">'
            ...
            //        + '<li><a href="/cabinetmgr/networkdevice/list/' + aData[0] + '" class="tooltip-success" data-rel="tooltip" title="" data-original-title="Edit">'
            //        + '<span class="green">'
    ...
    function buttonsDisable() {
        ...
        $("#btn-vertify").attr("disabled", 'disabled');
        $("#btn-disvertify").attr("disabled", 'disabled');
    }
...
// 通用的新增方法
    ...
    $("#btn-distribute-electricbox").bind("click",
        function () {
            current_page = pospDataTable.page()
            //alert(current_page)
            window.location.href = "/cabinetmgr/electricboxdistribute/list/add/"  + industry_id
        });
    $("#btn-retry").bind("click",
        function () {
            current_page = pospDataTable.page()
            //alert(current_page)
            window.location.href = "/cabinetmgr/electricboxdistribute/retry/" + workorder_id + '/'   + industry_id
        });
    $("#btn-vertify-detail").bind("click",
        function () {
            current_page = pospDataTable.page()
            window.location.href = DETAILE_LIST_URL
            //window.location.href = "/cabinetmgr/ipvertifyrecord/list/" + workorder_id
        });
