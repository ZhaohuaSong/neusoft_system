    ...
    var pospDataTable = $('#dynamic-table').DataTable({
            ...
            "fnRowCallback": function (nRow, aData, iDataIndex) {
                $('td:eq(-1)', nRow).html('<div class="hidden-sm hidden-xs action-buttons"> '
                    + '<a class="green" href="edit/' + aData[0] + '/' + industry_id + '">'
                    ...
                    + '<li><a href="edit/' + aData[0] + '/' + industry_id +'" class="tooltip-success" data-rel="tooltip" title="" data-original-title="Edit">'
                    + '<span class="green">'
    ...
    $("#btn-update").bind("click",
        function () {
            ...
            if (ids == 0) {
                ...
                window.location.href = "edit/" + ids[0] + '/' + industry_id
            }
        });
