...
// 通用的新增方法
    $("#btn-add").bind("click",
        function () {
            ...
            //alert(current_page)
            var args1 = $("#device_id").text();
            var reg = /(\d+)/;
            var reg1 = args1.match(reg);
    ...
    $("#btn-retry").bind("click",
        function () {
            current_page = pospDataTable.page()
            //alert(current_page)
            window.location.href = "/cabinetmgr/networkdevicedistribute/retry/" + workorder_id + '/' + industry_id
        });
    $("#btn-vertify-detail").bind("click",
        function () {
            current_page = pospDataTable.page()
            //alert(current_page)
            console.info(DETAILE_LIST_URL)
            window.location.href = DETAILE_LIST_URL
            //window.location.href = "/cabinetmgr/ipvertifyrecord/list/" + workorder_id
        });
    $("#btn-distribute-networkdevice").bind("click",
        function () {
            current_page = pospDataTable.page()
            //alert(current_page)
            window.location.href = "/cabinetmgr/networkdevicedistribute/list/add/" + industry_id
        });
