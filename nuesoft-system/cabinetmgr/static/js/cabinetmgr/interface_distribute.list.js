...
// 通用的新增方法
    ...
    $("#btn-distribute-interface").bind("click",
        function () {
            current_page = pospDataTable.page()
            //alert(current_page)
            window.location.href = "/cabinetmgr/interfacedistribute/list/add/" + workorder_id + '/' + industry_id
        });
    $("#btn-retry").bind("click",
        function () {
            current_page = pospDataTable.page()
            //alert(current_page)
            window.location.href = "/cabinetmgr/interfacedistribute/retry/" + workorder_id + '/' + industry_id
        });
