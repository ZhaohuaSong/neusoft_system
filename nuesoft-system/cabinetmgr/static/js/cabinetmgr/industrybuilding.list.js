    ...
    var pospDataTable = $('#dynamic-table').DataTable({
            ...
            "fnRowCallback": function (nRow, aData, iDataIndex) {
                $('td:eq(-1)', nRow).html('<div class="hidden-sm hidden-xs action-buttons"> '
                    + '<a class="green" href="/cabinetmgr/roomgraphfile/add/' + aData[0] + '">'
                    ...
                    + '<li><a href="/cabinetmgr/roomgraphfile/add/' + aData[0] + '" class="tooltip-success" data-rel="tooltip" title="" data-original-title="Edit">'
                    + '<span class="green">'
