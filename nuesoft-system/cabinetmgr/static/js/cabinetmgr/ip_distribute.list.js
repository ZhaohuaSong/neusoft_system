...
// 通用的新增方法
    ...
    $("#btn-distribute-ip").bind("click",
        function () {
            current_page = pospDataTable.page()
            //alert(current_page)
            window.location.href = "/cabinetmgr/ipdistribute/list/add/" + industry_id
        });
    $("#btn-retry").bind("click",
        function () {
            current_page = pospDataTable.page()
            //alert(current_page)
            window.location.href = "/cabinetmgr/ipdistribute/retry/" + workorder_id + '/' + industry_id
        });
