...
//  Datatables 初始化页面 关键绑定 ID (dynamic-table)
    ...
    function buttonsDisable() {
        ...
        $("#btn-fail").attr("disabled", 'disabled');
    }
...
// 通用的新增方法
    ...
    $("#btn-vertify").bind("click",
        function () {
            var ver_num = workorder_id;
            window.location.href = "/cabinetmgr/ipvertify/2/" + workorder_id
        });
    $("#btn-disvertify").bind("click",
        function () {
            current_page = pospDataTable.page()
            var ver_num = workorder_id;
            window.location.href = "/cabinetmgr/ipvertify/3/" + workorder_id
        });
