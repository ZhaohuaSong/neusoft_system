...
!function (a) {
    ...
    a.extend(i.prototype, {
                ...
                if (j)if (a.isArray(j))this._buildButtons(j, c, e); else {
                    ...
                    if (k) {
                        ...
                        if (c.append(k.inserter), e === d ? (this.s.buttons.push({
                                ...
                                conf: j,
                                inserter: k.inserter
                            }), this.s.subButtons.push([])) : this.s.subButtons[e].push({node: l, conf: j, inserter: k.inserter}), j.buttons) {
        ...
        for (var e = [], f = function (b, c) {
            ...
            }); else if ("number" == typeof b)e.push({inst: c, idx: b}); else if ("string" == typeof b)if (-1 !== b.indexOf(",")) {
                var k = b.split(",");
        ...
        collection: {
            text: function (a, b, c) {
                ...
                if (l && "absolute" === m)g._collection.css({top: l.top + 5, left: l.left + 5}); else if ("absolute" === m) {
            ...
            return {
                extend: "collection", text: g, className: "buttons-page-length", autoClose: !0, buttons: a.map(e, function (a, b) {
                    return {
