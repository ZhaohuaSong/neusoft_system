...
!function (a) {
    ...
    function j(b) {
        if (!Ua.__browser) {
            var c = {};
            Ua.__browser = c;
            var d = a("<div/>").css({position: "fixed", top: 0, left: 0, height: 1, width: 1, overflow: "hidden"}).append(a("<div/>").css({
                position: "absolute",
                top: 1,
                left: 1,
                width: 100,
                overflow: "scroll"
            }).append(a("<div/>").css({width: "100%", height: 10}))).appendTo("body"), e = d.children(), f = e.children();
    ...
    Ua = function (b) {
        ...
        return this.each(function () {
            ...
            a.extend(!0, G, p.oLanguage), "" !== G.sUrl && (a.ajax({
                dataType: "json", url: G.sUrl, success: function (b) {
    ...
    Xa("cells()", function (b, c, e) {
    ...
    }), Ua.version = "1.10.11", Ua.settings = [], Ua.models = {}, Ua.models.oSearch = {bCaseInsensitive: !0, sSearch: "", bRegex: !1, bSmart: !0}, Ua.models.oRow = {
        nTr: null,
        anCells: null,
        _aData: [],
        _aSortData: null,
        ...
        oLanguage: {
            ...
            sEmptyTable: "暂无相关数据",
            sInfo: "第 _START_ 条到 _END_ 条数据 共 _TOTAL_ 条 ",
            sInfoEmpty: "第 0 条到 0 条数据 共 0 条",
            sInfoFiltered: " ",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
