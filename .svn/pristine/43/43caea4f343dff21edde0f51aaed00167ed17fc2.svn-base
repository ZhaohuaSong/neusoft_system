...
!function (a) {
    ...
    function i(b) {
        ...
        if (c._select.info && c.aanFeatures.i) {
            var d = a('<span class="select-info"/>'), e = function (c, e) {
                d.append(a('<span class="select-item"/>').append(b.i18n("select." + c + "s", {_: "（%d） " + '行' + " 已选择", 0: "", 1: "（1） " + '行' + " 已选择"}, e)))
            };
    ...
    return p("select()", function () {
        ...
        selected: {
            ...
            text: n("selectedSingle", "Selected single"), className: "buttons-selected-single", init: function (a, b, c) {
                var d = this;
                a.on("draw.dt.DT select.dt.DT deselect.dt.DT", function () {
        ...
        o.ext.buttons["select" + b + "s"] = {
            text: n("select" + b + "s", "Select " + c + "s"), className: "buttons-select-" + c + "s", action: function () {
                this.select.items(c)
            }, init: function (a, b, d) {
                var e = this;
